(function () {
    ...
    angular
        ...
        .controller('SClassCtrl', ['$scope', '$state', '$window', '$http', 'aaNotify', '$rootScope','auth','store', 'StudentService',function ($scope, $state, $window, $http, aaNotify, $rootScope,auth,store,StudentService) {
            ...
            StudentService.GetDashboard().then(onStudetLoadComplete);
