(function () {
    ...
    angular
        ...
        .controller('AddAssignmentCtrl', ['$scope', '$state', '$window', '$http', 'aaNotify', '$rootScope', 'store', 'auth', 'TeacherService', function ($scope, $state, $window, $http, aaNotify, $rootScope, store, auth, TeacherService) {
