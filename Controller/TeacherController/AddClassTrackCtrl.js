(function () {
    ...
    angular
        ...
        .controller('AddClassTrackCtrl', ['$scope', '$state', '$window', '$http', 'aaNotify', '$rootScope', 'store', 'auth', 'TeacherService', function ($scope, $state, $window, $http, aaNotify, $rootScope, auth, store, TeacherService) {
