(function () {
    ...
    angular
        ...
        .controller('AddClassTrackSkillQuestionCtrl', ['$scope', '$state', '$window', '$http', '$rootScope', 'aaNotify', 'auth', 'store', 'TeacherService', function ($scope, $state, $window, $http, aaNotify, $rootScope, auth, store, TeacherService) {
